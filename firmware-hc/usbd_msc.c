...
/**
  ...
  * @retval status
  */
static USBD_MSC_BOT_HandleTypeDef temp;
...
uint8_t  USBD_MSC_Init (USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  ...
  pdev->pClassData[0] = &temp; //USBD_malloc(sizeof (USBD_MSC_BOT_HandleTypeDef));
  ...
  case USB_REQ_TYPE_CLASS:
    ...
    case BOT_GET_MAX_LUN:
         ...
         ((req->bmRequest & 0x80U) == 0x80U))
      {
        ...
        USBD_CtlSendData (pdev, (uint8_t *)(void *)&hmsc->max_lun, 4U);
      }
      else
      {
